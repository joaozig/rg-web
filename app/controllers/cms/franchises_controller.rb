class Cms::FranchisesController < Cms::CmsController
  ...
  def create
    ...
    respond_to do |format|
      if @franchise.save
        format.html { redirect_to cms_franchises_path, notice: 'Franchise was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @franchise.update(franchise_params)
        format.html { redirect_to cms_franchises_path, notice: 'Franchise was successfully updated.' }
  ...
  def destroy
    @franchise.destroy
    respond_to do |format|
      format.html { redirect_to cms_franchises_path, notice: 'Franchise was successfully destroyed.' }
  ...
  private
    ...
    def franchise_params
      params.fetch(:franchise, {}).permit(:logo, :plan, :image, :name, :summary, category_ids: [])
    end
end
